...
public class ClientLogger {
    ...
    private static Appender rocketmqClientAppender = createClientAppender();
    ...
    private static synchronized Appender createClientAppender() {
        String clientLogRoot = System.getProperty(CLIENT_LOG_ROOT, "./log/rocketmqlogs");
        String clientLogMaxIndex = System.getProperty(CLIENT_LOG_MAXINDEX, "2");
